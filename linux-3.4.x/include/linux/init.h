...
#define __fastpathsys	 __section(.text.fastpath) notrace
#define __fastpathnet	 __section(.text.fastpath) notrace
#define __fastpathbridge __section(.text.fastpath) notrace
#else
#define __fastpathsys
#define __fastpathnet
#define __fastpathbridge
#endif
