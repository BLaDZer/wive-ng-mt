...
static inline int __fastpathnet ip_finish_output2(struct sk_buff *skb)
{
...
static inline int __fastpathnet ip_finish_output(struct sk_buff *skb)
{
...
int __fastpathnet ip_output(struct sk_buff *skb)
{
