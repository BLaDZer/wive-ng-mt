...
class CoovaChilli:
    ...
    Query   = '/opt/Wive-MT/user/chillispot/coova-chilli-1.3.0/filesystem/sbin/chilli_query'
    Socket  = '/opt/Wive-MT/user/chillispot/coova-chilli-1.3.0/filesystem/var/run/chilli.sock'
    Init    = '/opt/Wive-MT/user/chillispot/coova-chilli-1.3.0/filesystem/etc/init.d/chilli'
    DefIni  = '/opt/Wive-MT/user/chillispot/coova-chilli-1.3.0/filesystem/etc/chilli/gui-config-default.ini'
    Ini     = '/opt/Wive-MT/user/chillispot/coova-chilli-1.3.0/filesystem/etc/chilli/gui-config.ini'
    Conf    = '/opt/Wive-MT/user/chillispot/coova-chilli-1.3.0/filesystem/etc/chilli/config'
