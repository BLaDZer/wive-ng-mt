var lang_dictionary = {
	...
	'warning update available'	: 'Доступно обновление системного ПО вашего устройства. Перейдите на страницу управления для установки обновления.',
	...
	'message reboot confirm'	: 'Применение некоторых настроек потребует перезагрузки маршрутизатора. Выполнить перезагрузку сейчас?',
