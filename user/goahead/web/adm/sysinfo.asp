<table class="form" >
	...
	<tr>
		...
		<td style="width: 60%"><% getSdkVersion(); %></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="head"><input type="hidden" id="inpSysUpTime" value='<% getSysUptime(); %>'><span id="statusSysUpTime">System Uptime</span></td>
		<td id="tdSysUpTime"></td>
	</tr>
	<tr>
