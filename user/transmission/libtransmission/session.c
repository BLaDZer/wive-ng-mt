...
tr_sessionGetDefaultSettings (tr_variant * d)
{
  ...
  tr_variantDictAddInt  (d, TR_KEY_speed_limit_down,                250);
  ...
  tr_variantDictAddInt  (d, TR_KEY_download_queue_size,             2);
  ...
  tr_variantDictAddInt  (d, TR_KEY_speed_limit_up,                  250);
...
tr_sessionInitImpl (void * vdata)
{
  ...
  **/
  ...
  tr_logAddError (_("%s %s started"), TR_NAME, LONG_VERSION_STRING);
