...
enum opt_code
{
  ...
  OPT_mabi_ = 1041,                          /* -mabi= */
  OPT_mabicalls = 1042,                      /* -mabicalls */
  OPT_mandroid = 1043,                       /* -mandroid */
  OPT_march_ = 1044,                         /* -march= */
  OPT_mbionic = 1045,                        /* -mbionic */
  OPT_mbranch_cost_ = 1046,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1047,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1048,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1049,                /* -mcode-readable= */
  OPT_mdebug = 1050,                         /* -mdebug */
  OPT_mdebugd = 1051,                        /* -mdebugd */
  OPT_mdivide_breaks = 1052,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1053,                  /* -mdivide-traps */
  OPT_mdmx = 1054,                           /* -mdmx */
  OPT_mdouble_float = 1055,                  /* -mdouble-float */
  OPT_mdsp = 1056,                           /* -mdsp */
  OPT_mdspr2 = 1057,                         /* -mdspr2 */
  OPT_meb = 1058,                            /* -meb */
  OPT_mel = 1059,                            /* -mel */
  OPT_membedded_data = 1060,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1061,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1062,                  /* -mextern-sdata */
  OPT_mfix_24k = 1063,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1064,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1065,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1066,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1067,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1068,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1069,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1070,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1071,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1072,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1073,                 /* -mfp-exceptions */
  OPT_mfp32 = 1074,                          /* -mfp32 */
  OPT_mfp64 = 1075,                          /* -mfp64 */
  OPT_mfused_madd = 1076,                    /* -mfused-madd */
  OPT_mglibc = 1077,                         /* -mglibc */
  OPT_mgp32 = 1078,                          /* -mgp32 */
  OPT_mgp64 = 1079,                          /* -mgp64 */
  OPT_mgpopt = 1080,                         /* -mgpopt */
  OPT_mhard_float = 1081,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1082,              /* -minterlink-mips16 */
  OPT_mips = 1083,                           /* -mips */
  OPT_mips16 = 1084,                         /* -mips16 */
  OPT_mips3d = 1085,                         /* -mips3d */
  OPT_mllsc = 1086,                          /* -mllsc */
  OPT_mlocal_sdata = 1087,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1088,                    /* -mlong-calls */
  OPT_mlong32 = 1089,                        /* -mlong32 */
  OPT_mlong64 = 1090,                        /* -mlong64 */
  OPT_mmad = 1091,                           /* -mmad */
  OPT_mmcount_ra_address = 1092,             /* -mmcount-ra-address */
  OPT_mmcu = 1093,                           /* -mmcu */
  OPT_mmemcpy = 1094,                        /* -mmemcpy */
  OPT_mmt = 1095,                            /* -mmt */
