...
#define __KERNEL_HEADERS__ "../linux/include"
...
#define __DEVEL_PREFIX__ "shared"
...
#define __CROSS_COMPILER_PREFIX__ "/opt/Wive-MT/toolchain/bin/mipsel-linux-uclibc-"
#define __UCLIBC_EXTRA_CFLAGS__ "-ffast-math -fforce-addr -fno-stack-protector -fno-strict-overflow -fno-var-tracking-assignments -fno-aggressive-loop-optimizations -fno-tree-slsr -fomit-frame-pointer -fno-delete-null-pointer-checks -femit-struct-debug-baseonly -fno-var-tracking"
#undef __DODEBUG__
